...
//% blockId="BH1750_SET_PIN_DOUT" block="set DOUT %DOUT"
...
//% blockId="BH1750_SET_PIN_SCK" block="set PD_SCK %PD_SCK"
//% weight=100 blockGap=8
...
//% blockId="HX711_READ_AVERAGE" block="read average (N)"
//% weight=80 blockGap=8
...
//% blockId="HX711_GET_VALUE" block="get value (N)"
//% weight=80 blockGap=8
export function get_value(times: number): number {
	return read_average(times) - OFFSET
}

//% blockId="HX711_GET_UNITS" block="get units (N)"
//% weight=80 blockGap=8
